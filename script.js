...
var P = [
  ...
  },
  {
    ...
    s: "NO.002",
    r: "AI 营销生态发起人",
    f: "素材/照片/NO002_金朝霞.jpg",
    b: "AI营销生态发起人，企业增长与数字化运营专家，AI智能体应用实践者。多年运营、品牌、招商孵化及数字化经验，专注AI获客、GEO增长与商业化落地。理念：AI不是替代企业，而是重新定义增长方式。",
    lv: "hi",
  },
  {
    n: "胡公平",
  ...
  },
  {
    ...
    b: "资深IT技术工程师，深耕软件开发与底层架构，具工程研发与落地经验。深耕新媒体内容生态，擅长内容策划、流量运营与商业营销。专注Web3与数字经济，融合技术、传播与产业洞察，输出深度与落地并重的行业思考。",
    lv: "mid",
  },
  {
    n: "李海畅",
  ...
  },
  {
    ...
    b: '资本视角商业策划师，首席战略官，资本运作专家。精财务模型与资本架构，擅模式创新与组织激活。独创"商学院+招商+资本"铁三角，打通治理、模式、资产证券化。理念：AI是参谋，你是司令。《AI指挥官》作者。',
    lv: "hi",
  },
];
...
(function () {
  ...
  /* 本次打开页面随机选一位起始出版人，之后按席位顺序 1→19 轮下去；刷新页面重新随机 */
